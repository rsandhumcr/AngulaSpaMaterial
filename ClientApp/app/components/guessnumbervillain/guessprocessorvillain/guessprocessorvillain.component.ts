...
@Component({
    selector: 'app-guessprocessorvillain',
    templateUrl: './guessprocessorvillain.component.html',
    styleUrls: ['./guessprocessorvillain.component.css']
})

export class GuessprocessorVillainComponent implements OnInit {
