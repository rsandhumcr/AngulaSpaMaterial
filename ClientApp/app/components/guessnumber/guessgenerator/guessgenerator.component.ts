...
export class GuessgeneratorData {
    username: string;
    minvalue: number;
    maxvalue: number;
}
...
@Component({
    selector: 'app-guessgenerator',
    templateUrl: './guessgenerator.component.html',
    styleUrls: ['./guessgenerator.component.css']
})
export class GuessgeneratorComponent implements OnInit {

    @Output() processentry = new EventEmitter<GuessgeneratorData>();
    ...
    public processNumber() {
        let guessgeneratorData = new GuessgeneratorData();
